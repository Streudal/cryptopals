...
import { decryptAES128ECB, detectECB, xorBuffers, repeatingKeyXOR, detectSingleByteXOR, fixedXOR } from '../lib/challenges'; // Assuming each function is in a 'challenges' file
