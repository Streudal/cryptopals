...
// Correct Base64 result for the provided hex string
const correctBase64 = 'SSdtIGtpbGxpbmcgeW91ciBicmFpbiBsaWtlIGEgcG9pc29ub3VzIG11c2hyb29t';
...
export default function Challenge() {
  ...
  // Test user input against correct Base64 string
  const testUserCode = () => {
    // Compare user input with the correct Base64 string
    if (userInput === correctBase64) {
      setFeedback('Correct! Well done.');
    } else {
      setFeedback(`Incorrect. Your output: ${userInput}`);
    }
  };
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: '20px' }}>
        <p>Convert the following hex string to Base64:</p>
        <code>49276d206b696c6c696e6720796f757220627261696e206c696b65206120706f69736f6e6f7573206d757368726f6f6d</code>
        
        <textarea
          value={userInput}
          onChange={(e) => setUserInput(e.target.value)}
          placeholder="Enter the Base64 equivalent here"
          rows={5}
          cols={50}
        />
        <br />
        <button onClick={testUserCode}>Submit</button>
      </div>
