  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div className='flex flex-col gap-2'>
        <p><a className='text-blue-400 hover:cursor-pointer hover:underline' href='/assets/set-1-challenge-data-7.txt' target='_blank'>In this file</a> are a bunch of hex-encoded ciphertexts.</p>
